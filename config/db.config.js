...
module.exports = {
    ...
    MONGO_URL: process.env.MONGO_URL || 'mongodb+srv://<username>:<password>@cluster0.jl5qj.mongodb.net/myFirstDatabase?retryWrites=true&w=majority',
    MONGO_DB_NAME: process.env.MONGO_DB_NAME || 'myFirstDatabase'
};